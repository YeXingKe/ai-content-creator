...
// Agent2DescriptionSection 用户补充描述部分（动态插入到 Agent2OutlinePrompt）
const Agent2DescriptionSection = `
...
// AiModifyOutlinePrompt AI 修改大纲提示词
const AiModifyOutlinePrompt = `你是一位专业的文章策划师,擅长根据用户反馈优化文章结构。
